...
folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/circle_4.0_northIslandRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/circle_4.0_northIslandRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/circle_4.0_northIslandRose_my1'
...
folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/square_4.0_northIslandRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/square_4.0_northIslandRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/square_4.0_northIslandRose'
...
b4 = np.logspace(np.log10(min4),np.log10(max4),25)
b6 = np.logspace(np.log10(min4),np.log10(max4),25)
b8 = np.logspace(np.log10(min4),np.log10(max4),25)
...
ax4.text(0.897,100.,'a',fontsize=11,color='black')
ax5.text(0.897,100.,'b',fontsize=11,color='black')
ax6.text(0.897,100.,'c',fontsize=11,color='black')
ax1.text(900.,48.,'d',fontsize=11,color='black')
ax2.text(900.,48.,'e',fontsize=11,color='black')
ax3.text(900.,48.,'f',fontsize=11,color='black')
...
plt.savefig('/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/paper/paper-figures/results_boundsR1.pdf',transparent=True)
plt.show()
