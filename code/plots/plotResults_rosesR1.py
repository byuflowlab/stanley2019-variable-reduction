...
folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/amalia_4.0_ukiahRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/amalia_4.0_ukiahRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/amalia_4.0_ukiahRose'
...
folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/amalia_4.0_victorvilleRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/amalia_4.0_victorvilleRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/amalia_4.0_victorvilleRose_my1'
...
"""wind rose"""
max_height = max(wf)
bars = ax7.bar(wd, wf, width=width, bottom=bottom, color='C2',alpha=0.5)
...
"""wind rose"""
max_height = max(wf)
bars = ax8.bar(wd, wf, width=width, bottom=bottom, color='C2',alpha=0.5)
thetaticks = np.arange(0,360,45)
...
"""wind rose"""
max_height = max(wf)
bars = ax9.bar(wd, wf, width=width, bottom=bottom, color='C2',alpha=0.5)
...
# b4 = np.append(b4,b4[23]+b4[1]-b4[0])
# b6 = np.append(b6,b6[23]+b6[1]-b6[0])
# b8 = np.append(b8,b8[23]+b8[1]-b8[0])
...
ax4.hist(AEP_grid4[0:num],bins=b4,color='C1',alpha=0.5,label='grid',align='left',ec='None')
ax5.hist(AEP_grid6[0:num],bins=b6,color='C1',alpha=0.5,align='left',ec='None')
ax6.hist(AEP_grid8[0:num],bins=b8,color='C1',alpha=0.5,align='left',ec='None')
ax4.hist(AEP_param4[0:num],bins=b4,color='C0',alpha=0.5,label='parameterized',align='left',ec='None')
ax5.hist(AEP_param6[0:num],bins=b6,color='C0',alpha=0.5,align='left',ec='None')
ax6.hist(AEP_param8[0:num],bins=b8,color='C0',alpha=0.5,align='left',ec='None')
ax4.hist(AEP_direct4[0:num],bins=b4,color='C2',alpha=0.5,label='direct',align='left',ec='None')
ax5.hist(AEP_direct6[0:num],bins=b6,color='C2',alpha=0.5,align='left',ec='None')
ax6.hist(AEP_direct8[0:num],bins=b8,color='C2',alpha=0.5,align='left',ec='None')
ax4.hist(AEP_param4[0:num],bins=b4,color='C0',alpha=0.5,align='left',ec='None')
ax5.hist(AEP_param6[0:num],bins=b6,color='C0',alpha=0.5,align='left',ec='None')
ax6.hist(AEP_param8[0:num],bins=b8,color='C0',alpha=0.5,align='left',ec='None')
...
ax4.text(0.897,105.,'a',fontsize=11,color='black')
ax5.text(0.897,105.,'b',fontsize=11,color='black')
ax6.text(0.897,105.,'c',fontsize=11,color='black')
ax1.text(900.,34.,'d',fontsize=11,color='black')
ax2.text(900.,34.,'e',fontsize=11,color='black')
ax3.text(900.,34.,'f',fontsize=11,color='black')
...
# plt.savefig('/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/paper/paper-figures/results_rosesR1.pdf',transparent=True)
plt.show()
