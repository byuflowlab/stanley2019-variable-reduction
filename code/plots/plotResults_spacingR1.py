...
folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/amalia_4.0_northIslandRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/amalia_4.0_northIslandRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/amalia_4.0_northIslandRose'

with open('%s/AEPtrue.txt'%folder_grid) as my_file:
...
for p in range(len(f_grid4)):
    f_grid4[p] = float(f_grid4[p])*120.

with open('%s/AEPtrue.txt'%folder_direct) as my_file:
...
for p in range(len(f_direct4)):
    f_direct4[p] = float(f_direct4[p])*120.

with open('%s/AEPtrue.txt'%folder_param) as my_file:
...
for p in range(len(f_param4)):
    f_param4[p] = float(f_param4[p])*120.





folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/amalia_6.0_northIslandRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/amalia_6.0_northIslandRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/amalia_6.0_northIslandRose'
...
for p in range(len(f_direct6)):
    f_direct6[p] = float(f_direct6[p])*120.
...
for p in range(len(f_param6)):
    f_param6[p] = float(f_param6[p])*120.


folder_direct = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/direct/amalia_8.0_northIslandRose'
folder_param = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/param/amalia_8.0_northIslandRose'
folder_grid = '/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/code/plots/revised_data/opt-results-revision/grid/amalia_8.0_northIslandRose'
...
for p in range(len(f_direct8)):
    f_direct8[p] = float(f_direct8[p])*120.
...
for p in range(len(f_param8)):
    f_param8[p] = float(f_param8[p])*120.
...
#     circ = plt.Circle((X[i],Y[i]),0.5,facecolor='C0',edgecolor='C0',alpha=0.5)
#     ax7.add_patch(circ)
#
# s = 6.
# x = np.array([-2.*s,-s,0.,s,2.*s])
...
ax7.set_xlim(min(bx8),max(bx8))
ax8.set_xlim(min(bx8),max(bx8))
ax9.set_xlim(min(bx8),max(bx8))

ax7.set_ylim(min(by8),max(by8))
ax8.set_ylim(min(by8),max(by8))
ax9.set_ylim(min(by8),max(by8))


# plt.show()
for i in range(nTurbs):
    circ = plt.Circle((x4[i],y4[i]),rotorDiameter[0]/2.,facecolor='C0',edgecolor='C0',alpha=0.5)
    ax7.add_patch(circ)
    circ = plt.Circle((x6[i],y6[i]),rotorDiameter[0]/2.,facecolor='C0',edgecolor='C0',alpha=0.5)
    ax8.add_patch(circ)
    circ = plt.Circle((x8[i],y8[i]),rotorDiameter[0]/2.,facecolor='C0',edgecolor='C0',alpha=0.5)
    ax9.add_patch(circ)
...
ax4.hist(AEP_grid4[0:num],bins=b4,color='C1',alpha=0.5,label='grid',align='left')
ax5.hist(AEP_grid6[0:num],bins=b6,color='C1',alpha=0.5,align='left')
ax6.hist(AEP_grid8[0:num],bins=b8,color='C1',alpha=0.5,align='left')
ax4.hist(AEP_param4[0:num],bins=b4,color='C0',alpha=0.5,label='parameterized',align='left')
ax5.hist(AEP_param6[0:num],bins=b6,color='C0',alpha=0.5,align='left')
ax6.hist(AEP_param8[0:num],bins=b8,color='C0',alpha=0.5,align='left')
ax4.hist(AEP_direct4[0:num],bins=b4,color='C2',alpha=0.5,label='direct',align='left')
ax5.hist(AEP_direct6[0:num],bins=b6,color='C2',alpha=0.5,align='left')
ax6.hist(AEP_direct8[0:num],bins=b8,color='C2',alpha=0.5,align='left')
ax4.hist(AEP_param4[0:num],bins=b4,color='C0',alpha=0.5,align='left')
ax5.hist(AEP_param6[0:num],bins=b6,color='C0',alpha=0.5,align='left')
ax6.hist(AEP_param8[0:num],bins=b8,color='C0',alpha=0.5,align='left')
...
ticks = np.array([1000.,10000.,100000.,1000000.])
ax1.set_xticks(ticks)
ax1.set_xticklabels((r'10$^3$',r'10$^4$',r'10$^5$',r'10$^6$'))
ax2.set_xticks(ticks)
ax2.set_xticklabels((r'10$^3$',r'10$^4$',r'10$^5$',r'10$^6$'))
ax3.set_xticks(ticks)
ax3.set_xticklabels((r'10$^3$',r'10$^4$',r'10$^5$',r'10$^6$'))
ax1.set_xlim(700.,200000.)
...
ax5.set_xlim(0.89,1.01)
ax6.set_xlim(0.89,1.01)
...
ax4.text(0.897,92.,'a',fontsize=11,color='black')
ax5.text(0.897,92.,'b',fontsize=11,color='black')
ax6.text(0.897,92.,'c',fontsize=11,color='black')
ax1.text(900.,37.,'d',fontsize=11,color='black')
ax2.text(900.,37.,'e',fontsize=11,color='black')
ax3.text(900.,37.,'f',fontsize=11,color='black')
...
plt.savefig('/Users/ningrsrch/Dropbox/Projects/stanley2019-variable-reduction/paper/paper-figures/results_spacingR1.pdf',transparent=True)
plt.show()
