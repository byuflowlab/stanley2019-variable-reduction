...
!  Differentiation of calcaep in forward (tangent) mode (with options multiDirectional i4 dr8 r4):
!   variations   of useful results: aep
!   with respect to varying inputs: turbinex turbiney
!   RW status of diff variables: turbinex:in turbiney:in aep:out
SUBROUTINE CALCAEP_DV(nturbines, ndirections, turbinex, turbinexd, &
& turbiney, turbineyd, turbinez, rotordiameter, winddirections, &
& windspeeds, windfrequencies, shearexp, relaxationfactor, rated_ws, &
& rated_power, cut_in_speed, cut_out_speed, zref, z0, aep, aepd, nbdirs)
...
& rated_power, cut_in_speed, cut_out_speed, zref, z0
  REAL(dp), DIMENSION(nturbines), INTENT(IN) :: turbinex, turbiney, &
