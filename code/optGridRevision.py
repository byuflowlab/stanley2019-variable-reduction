...
if __name__ == "__main__":
    ...
    folder = 'opt-results-revision/grid/%s_%s_%s_my1'%(boundary,spacing,rose)
    ...
    for i in range(num):
        ...
        dx_start,dy_start,shear_start,rotate_start,turbs_per_row,x_start,y0 = startGrid(nTurbines,
                            boundaryVertices*0.95,boundaryNormals,rotate=rotate,my=1.0)
        ...
        # prob['rotate'] = float(np.random.rand(1))*20.-10.
        # prob['dx'] = dx_start
        # prob['dy'] = dy_start
