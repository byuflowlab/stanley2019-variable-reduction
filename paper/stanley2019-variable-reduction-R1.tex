...
%\footnote{https://www.nrel.gov/wind/assets/pdfs/se17-9-iea-wind-task-37-systems-engineering.pdf}. 
...
% The details for how local turbulence intensity is determined can be found in the cited literature \cite{bastankhah2016experimental,Thomas2018}. 
%maybe would be good to have a few sources "in the cited literature, especially ..." instead of making your readers wade through all 20 sources or however many sources
...
%Additionally, past research leads us to conclude that the large number of random starting points used in our gradient-based optimization are sufficient to search the design space.
%and give us solutions that perform similarly to the solutions that would be obtained with gradient-free optimization techniques \citep{Thomas2018,Baker2019}.
